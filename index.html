  ...
  <header class="pc_web">
      ...
      <summary>Меню</summary>
        <p>
          ...
          <div class="header-content-кино">
            ...
            <p></p>
            <p class="header-content-a"><a href="index.html">Кино</a></p>
            <p></p>
    ...
    <details class="header-content-auth">
      ...
      <summary>Аккаунт</summary>
        <p>
          <p class="header-content-a"><a href="Вход/Login.php">Авторизация</a></p>
          <p></p>
          или
          <p></p>
          <p class="header-content-a"><a href="Вход/Register.php">Регистрация</a></p>
        </p>

      <?php else:?>
      <summary><?=$_COOKIE['user']?></summary>
        <p>
          <p class="header-content-a"><a href="Вход/exit.php">Выход</a></p>
        </p>
      <?php endif;?>
    </details>
  </header>
